          ...
          <DialogFooter className="shrink-0 mt-2">
            {
              ...
              <div className="flex w-full gap-3">
                ...
                <Button className="cursor-pointer w-1/2 py-5 bg-[var(--secondary-color)] hover:bg-[var(--secondary-color)]" onClick={event}>{langChange.confirm}</Button>
              </div>:
              <Button className="cursor-pointer w-full py-5 bg-[var(--secondary-color)] hover:bg-[var(--secondary-color)]" onClick={() => setOpen(false)}>{langChange.confirm}</Button>
            }
          </DialogFooter>
        </DialogContent>
    </Dialog>
